...
- [**Triggers**](../../triggers/index.mdx) (webhooks, SQS, Kafka, etc.) will resume once servers are running. Some trigger messages may need to be reprocessed depending on the trigger type's at-least-once guarantees.
...
Your Windmill [license key](../../enterprise/1_plans_details/index.mdx) is stored in the database and is not tied to a specific server or cluster. It will work on the secondary datacenter without any changes.
