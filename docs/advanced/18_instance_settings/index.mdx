...
The Guests tab, next to Users, lists the [guests](../../core_concepts/16_roles_and_permissions/index.mdx#guests) of the trailing 30 days: people the identity provider authenticated who opened an app set to Guests without a Windmill account.
