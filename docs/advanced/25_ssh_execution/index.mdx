...
- No [nsjail sandbox](../27_security_isolation/index.mdx): the script runs as the SSH user with that user's full privileges. Scope the key and user tightly.
- No S3/binary cache.
