...
\* This memory-based rule does not apply to [native workers](../../core_concepts/9_worker_groups/index.mdx#native-worker-group), which always count as 1 CU regardless of their memory limit.
