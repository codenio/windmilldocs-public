...
- **Enterprise**: Enable Windmill [Enterprise features](https://www.windmill.dev/docs/enterprise/plans_details#upgrading-to-enterprise-edition) (requires license key)
