...
[Superadmins](../../core_concepts/16_roles_and_permissions/index.mdx) and anyone with access to [Windmill Customer Portal](../1_plans_details/index.mdx#windmill-customer-portal) can configure the following dashboard settings from the portal:
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		href="/docs/enterprise/plans_details#windmill-customer-portal"
	/>
</div>