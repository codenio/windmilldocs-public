...
The preprocessor is only called when the runnable is triggered via a [webhook](../4_webhooks/index.mdx), an [HTTP route](../../triggers/2_http_routing/index.mdx), an [email trigger](../../triggers/1_email_triggers/index.mdx), a [WebSocket trigger](../../triggers/3_websocket_triggers/index.mdx), a [Kafka trigger](../../triggers/5_kafka_triggers/index.mdx), a [NATS trigger](../../triggers/6_nats_triggers/index.mdx), a [Postgres trigger](../../triggers/4_postgres_triggers/index.mdx), an [SQS trigger](../../triggers/7_sqs_triggers/index.mdx), an [MQTT trigger](../../triggers/8_mqtt_triggers/index.mdx), a [GCP Pub/Sub trigger](../../triggers/9_gcp_triggers/index.mdx), an [Azure Event Grid trigger](../../triggers/10_azure_triggers/index.mdx), a [native trigger](../../triggers/11_native_triggers/index.mdx) or a [tool call over MCP](../51_mcp/index.mdx#reading-the-callers-request-headers).
