---
description: How does versioning work in Windmill? Scripts, flows and apps keep a version per deployment, and resources keep one per value change.
---
...
Scripts, Flows and Apps have unique versions when deployed. You can find the said version any time, fork it or go back to this version. [Resources](../3_resources_and_types/index.mdx#version-history) keep a version for every value change rather than for every deployment, but are browsed from the same kind of `History` drawer.
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	/>
	<DocCard
		title="Resource version history"
		description="Diff and restore past values of a resource."
		href="/docs/core_concepts/resources_and_types#version-history"
	/>
</div>
