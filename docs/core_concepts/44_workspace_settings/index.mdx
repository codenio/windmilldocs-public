...
- Apps (under Advanced) - Configure the [default app](../../apps/1_default_app/index.md), [rate limiting for public apps](../../apps/8_public_apps.mdx#rate-limiting) and whether the workspace [admits guests](../../apps/13_guest_apps/index.mdx#allowing-guests-in-a-workspace)
