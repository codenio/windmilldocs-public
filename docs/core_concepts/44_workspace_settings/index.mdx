...
- [Dev workspace](../../advanced/26_dev_workspaces/index.mdx) - Pair a dev workspace, choose which items the [deployment UI](../12_staging_prod/index.md) may promote, and set a [workspace on another instance](../12_staging_prod/index.md#deploy-to-a-workspace-on-another-instance) to deploy to
...
- [Windmill AI](../22_ai_generation/index.mdx) - Configure AI-assisted features, or [hide the AI assistant](../22_ai_generation/index.mdx#hiding-the-ai-assistant-in-a-workspace) from the workspace UI
- [Object Storage (S3)](../38_object_storage_in_windmill/index.mdx#workspace-object-storage) - Set up S3-compatible storage
- [dbt](../../getting_started/0_scripts_quickstart/16_dbt_quickstart/index.mdx#configure-a-warehouse) - Name the warehouses [dbt](../../getting_started/0_scripts_quickstart/16_dbt_quickstart/index.mdx) projects build against
- Apps (under Advanced) - Configure the [default app](../../apps/1_default_app/index.md), [rate limiting for public apps](../../apps/8_public_apps.mdx#rate-limiting), whether the workspace [admits guests](../../apps/13_guest_apps/index.mdx#allowing-guests-in-a-workspace) and the [key that verifies their JWTs](../../apps/13_guest_apps/index.mdx#configuring-the-verification-key)
- Encryption (under Advanced) - [Manage encryption keys and settings](../30_workspace_secret_encryption/index.mdx)
- Dependencies (under Advanced) - [Centralized dependency management](../55_workspace_dependencies/index.mdx) for scripts
- [General](#general)
