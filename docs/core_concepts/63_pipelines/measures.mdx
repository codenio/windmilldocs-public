...
{/* TODO: screenshot of the Metrics drawer — a table selected in the left list (with measure/dimension counts), a measure and a dimension checked, and the composed SELECT with a Copy button below. */}
