...
Job debouncing is a [Cloud plans and Self-Hosted Enterprise Edition](/pricing) feature.
...
When using [Postgres triggers](../../triggers/4_postgres_triggers/index.mdx) to react to row changes:
...
High-frequency sensor data arriving via [MQTT triggers](../../triggers/8_mqtt_triggers/index.mdx):
