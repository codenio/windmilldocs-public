...
You can use `:param` in the route path and access these as `params` in a [preprocessor](../43_preprocessors/index.mdx).
...
- Secrets stored as [variables](../2_variables_and_secrets/index.mdx)
