...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		title="JSON schema and parsing - Advanced settings"
		description="Arguments can be given advanced settings that will affect the inputs' auto-generated UI and JSON Schema."
		href="/docs/core_concepts/json_schema_and_parsing#advanced-settings"
	/>
	<DocCard
		title="Generated UI"
		description="Main function's arguments can be given advanced settings that will affect the inputs' auto-generated UI and JSON Schema."
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="AI form filling, chat and in-editor copilots for scripts, flows and apps."
		href="/docs/core_concepts/ai_generation#ai-form-filling"
	/>
</div>
...
This is the recommended way to share scripts and flows with [operators](../16_roles_and_permissions/index.mdx), the second option being to share the script and the [variables](../2_variables_and_secrets/index.mdx) it depends on. Note that sharing a variable with an operator gives them read access to its value, secrets included (see [Operator](../16_roles_and_permissions/index.mdx#operator)).
