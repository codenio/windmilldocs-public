...
In the global AI chat and AI sessions, you can attach images to your messages by dragging and dropping them into the chat, pasting from the clipboard, or using the file picker. This is useful to share a screenshot of a visual bug, a design mockup, or a diagram for the AI to work from. You can send up to 8 images per message (20MB and 40 megapixels each), with or without accompanying text. Click any image thumbnail to view it at full resolution.

<!-- PLACEHOLDER: Screenshot of the AI chat input with an image attached as a thumbnail chip above the input field, similar to the pr-image-attach screenshot from windmill PR #10130 -->
