...
Without git, you can also [deploy item by item from the UI to a workspace on another instance](../12_staging_prod/index.md#deploy-to-a-workspace-on-another-instance).
...
![VS Code Extension](../../../blog/2023-11-20-vscode/vscode_extension.png.webp 'VS Code extension')
