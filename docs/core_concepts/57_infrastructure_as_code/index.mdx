...
| `object_store_cache_config` | object | Object storage this group caches dependencies in, instead of the instance one ([Enterprise Edition](/pricing)). Same shape as the instance object storage settings, see [dependency cache object storage](../9_worker_groups/index.mdx#dependency-cache-object-storage) |
