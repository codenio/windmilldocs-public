...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		href="/docs/triggers/email_triggers"
	/>
	<DocCard
		title="Windmill MCP"
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		href="/docs/advanced/self_host#architecture"
	/>
	<DocCard
	...
	<DocCard
		title="Volumes"
		description="Persistent file storage attached to scripts via code annotations, synced to object storage across job runs."
		href="/docs/core_concepts/volumes"
	/>
	<DocCard
		title="Custom instance database"
		description="Use the Windmill Postgres database as persistent storage for your workspace, without any external setup."
		href="/docs/core_concepts/custom_instance_database"
	/>
	<DocCard
	...
	<DocCard
		title="dbt"
		description="Run an unmodified dbt project as a Windmill script, on your own workers, with its models on the asset graph."
	...
	<DocCard
		...
		description="There are multiple ways to do error handling in Windmill."
	...
	<DocCard
		...
		description="AI chat and in-editor copilots for scripts, flows and apps, plus model providers and settings."
	...
	<DocCard
		...
		description="Run a reusable AI agent against a dataset of cases, score the answers, and compare runs."
		href="/docs/core_concepts/ai_agent_evals"
	/>
	<DocCard
		title="AI sandbox"
		description="Run AI coding agents like Claude Code, Codex or OpenCode in Windmill with sandboxing and persistent file storage."
		href="/docs/core_concepts/ai_sandbox"
	/>
	<DocCard
		title="Workspace settings"
		description="Configuration options specific to each workspace: users, Git sync, storage, and more."
		href="/docs/core_concepts/workspace_settings"
	/>
	<DocCard
		title="Labels"
		description="Organize scripts, flows, apps, resources, variables, schedules and triggers with labels."
		href="/docs/core_concepts/labels"
	/>
	<DocCard
		title="Trashbin"
		description="Restore accidentally deleted scripts, flows, apps and other workspace items."
		href="/docs/core_concepts/trashbin"
	/>
</div>
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		color="teal"
		title="AI Flow Chat"
		description="Build and edit flows from natural language prompts."
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		href="/docs/core_concepts/object_storage_in_windmill#instance-object-storage-distributed-cache-for-python-rust-go"
	/>
	<DocCard
