...
Windmill can connect to Google Cloud Pub/Sub subscriptions and trigger scripts or flows when messages are published to a topic. Preprocessors can transform the Pub/Sub message data before it reaches your script or flow.
