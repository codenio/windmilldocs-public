...
- [background runnables](../3_app-runnable-panel.mdx#background-runnables) are run in the background on app refresh or when an input changes
- [frontend scripts](../3_app-runnable-panel.mdx#frontend-scripts) can be used to manipulate the client app state
...
- [Connect an input to an output](#connecting-inputs--outputs).
