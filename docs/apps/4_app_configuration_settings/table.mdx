...
TanStack Table has been deprecated and will be removed in the future. Please use the [AgGrid table](./aggrid_table.mdx) or [Database studio](./database_studio.mdx) components instead.
