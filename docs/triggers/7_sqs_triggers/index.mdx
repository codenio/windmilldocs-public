...
If you use a [preprocessor](../../core_concepts/43_preprocessors/index.mdx), the preprocessor function receives an SQS message with the following fields:
...
SQS triggers support local error handlers that override workspace error handlers for specific triggers. See the [error handling documentation](../../core_concepts/10_error_handling/index.mdx#trigger-error-handlers) for configuration details and examples.