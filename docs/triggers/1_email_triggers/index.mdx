...
Once you have defined the DNS settings, set the email domain in the [instance settings](../../advanced/18_instance_settings/index.mdx#email-domain) under the "Core" tab.
