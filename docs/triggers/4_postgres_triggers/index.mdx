...
- Postgres resource: a Postgres [resource](../../core_concepts/3_resources_and_types/index.mdx) must be configured in your environment to enable this feature.
...
Postgres triggers support local error handlers that override workspace error handlers for specific triggers. See the [error handling documentation](../../core_concepts/10_error_handling/index.mdx#trigger-error-handlers) for configuration details and examples.