...
Check our pages dedicated to [Scheduling](../core_concepts/1_scheduling/index.mdx) and [Triggering flows](../triggers/index.mdx).
...
![Example of a schedule script with a for loop](../triggers/schedule-script.png 'Example of a schedule script with a for loop')

![Schedule](../triggers/schedule-flow.png 'Schedule')
