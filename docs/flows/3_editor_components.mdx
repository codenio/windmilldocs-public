...
See [Triggering flows](../triggers/index.mdx) for more details.
...
There are three ways to create an action script:

- Write it directly in the flow editor.
- Import it from the Hub.
- Import it from the workspace.

A step can also run another flow of the workspace instead of a script, see [Subflows](./1_flow_editor.mdx#subflows).

## Inline action script

You can either create a new action script in:

- [TypeScript](../getting_started/0_scripts_quickstart/1_typescript_quickstart/index.mdx): Windmill uses Bun as the default TypeScript runtime (Deno is also available).
...
- [Bash](../getting_started/0_scripts_quickstart/4_bash_quickstart/index.mdx), [PowerShell](../getting_started/0_scripts_quickstart/4_bash_quickstart/index.mdx) and [Nu](../getting_started/0_scripts_quickstart/4_bash_quickstart/index.mdx).
- [PHP](../getting_started/0_scripts_quickstart/8_php_quickstart/index.mdx), [Rust](../getting_started/0_scripts_quickstart/9_rust_quickstart/index.mdx), [C#](../getting_started/0_scripts_quickstart/11_csharp_quickstart/index.mdx), [Java](../getting_started/0_scripts_quickstart/13_java_quickstart/index.mdx), [Ruby](../getting_started/0_scripts_quickstart/14_ruby_quickstart/index.mdx), [R](../getting_started/0_scripts_quickstart/15_rlang_quickstart/index.mdx) and [Ansible](../getting_started/0_scripts_quickstart/10_ansible_quickstart/index.mdx).
...
as well as [REST](../getting_started/0_scripts_quickstart/6_rest_grapqhql_quickstart/index.mdx) and [GraphQL](../getting_started/0_scripts_quickstart/6_rest_grapqhql_quickstart/index.mdx).

These are essentially templates to easily write queries to a database or endpoint.
...
- Format: format the script. Can be triggered on save (CTRL+S).
