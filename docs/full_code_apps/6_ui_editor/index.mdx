...
In an [AI session](../../core_concepts/69_ai_sessions/index.mdx#debugging-full-code-apps), the AI can read the preview's rendered DOM, console logs and job runs to debug the app, and you can click elements in the preview to attach them to your chat message. The AI can also capture the preview with its [`take_screenshot` tool](../../core_concepts/22_ai_generation/index.mdx#app-preview-screenshots) (Google Chrome only), and you can drag screenshots into the chat as [image attachments](../../core_concepts/22_ai_generation/index.mdx#image-attachments).
