...
You know how to configure [SAML, SCIM](../14_saml_and_scim/index.md) and other [authentication methods](../../core_concepts/15_authentication/index.mdx) for large organizations.
