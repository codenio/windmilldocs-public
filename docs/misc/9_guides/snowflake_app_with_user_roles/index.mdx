...
Note that the mechanism of using the end-user's role demonstated here with Snowflake can be used for any [OAuth-supported resource in Windmill](../../../advanced/27_setup_oauth/index.mdx#oauth) such as GitHub, Slack, or Google Workspace.
...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		href="/docs/advanced/setup_oauth#snowflake"
		target="_blank"
	/>
</div>
...
1. **Set up Snowflake OAuth**: Follow the [Snowflake OAuth guide](../../../advanced/27_setup_oauth/index.mdx#snowflake).
