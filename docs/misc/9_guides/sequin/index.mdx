...
**Step 1**: From the <a href="https://app.windmill.dev/" rel="nofollow">Home page</a>, click **New** and select **Script**.
...
To write your first mutation query, navigate to "Home" on the left sidebar, click **New** and select **Script**.
