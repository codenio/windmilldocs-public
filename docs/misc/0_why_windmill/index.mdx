...
- **[Triggers](../../getting_started/8_triggers/index.mdx)** for every script and flow: [webhooks](../../core_concepts/4_webhooks/index.mdx), [schedules](../../core_concepts/1_scheduling/index.mdx), HTTP routes, queues and more, plus an open API to embed Windmill into your existing infrastructure.
