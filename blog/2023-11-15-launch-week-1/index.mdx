...
Second announcement of the day is the Windmill [VS Code extension](https://marketplace.visualstudio.com/items?itemName=windmill-labs.windmill).
...
Today's first announcement of the day is the power of Worker Groups Configurations UI Management & Hot Reloading.
...
<div className="grid grid-cols-2 gap-6 mb-4">
	<DocCard
		...
		description="Assign workers dedciated to a script for maximum performance by removing cold starts"
...
Not only that, but we also took care of doing an exhaustive hierarchy of classes that correspond to the structure ou our components, enabling to customize any aspect of them.
...
- Docs - [React app import](/docs/full_code_apps)
