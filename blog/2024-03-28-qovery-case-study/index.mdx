...
The killer feature here was the ability to easily combine schedules with the conditional execution of a series of tasks, what Windmill calls [Trigger Flows](/docs/triggers#scheduled-polls-scheduling--trigger-scripts).